...
- When creating a branch for a gitrack issue, derive a human-readable slug of at most four words from the exact issue title and include the issue ref for precision: `codex/<short-title>-<ref>`.
