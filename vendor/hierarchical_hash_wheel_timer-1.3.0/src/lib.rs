...
//!
//! # 3 – High Level APIs
//! This crate also provides three high levels APIs that can either be used directly or can be seen as examples
...
//!
//! ## Manual Timer
//! The [manual_timer](manual_timer) module provides the same queue-based scheduling API as the thread timer,
//! but advances only when the caller explicitly steps time forward.
